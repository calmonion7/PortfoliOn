...
from routers.stocks import _latest_snapshot, _usdkrw_rate  # 저장값 read 헬퍼 재사용(라이브 호출 0)
import scheduler
...
def get_recommendations(
    ...
    # 요청경로 외부호출 0 — _latest_snapshot(저장 스냅샷)·_usdkrw_rate(저장 FX)만 읽는다.
    holdings = []
