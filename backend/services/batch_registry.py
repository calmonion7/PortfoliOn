...
"""배치 레지스트리 — 현황 허브가 노출하는 35개 배치의 정적 메타데이터.
...
BATCHES = [
    ...
    {
        "id": "business_formation_fetch",
        "label": "신규 창업 신청 수집",
        "category": "market",
        "schedule_desc": "매일 06:10",
        "usage": ["Market Hub 신규 창업 신청"],
        "source": ["FRED"],
        "editable": True,
        "trigger_kinds": ["auto", "manual"],
        "manual_endpoint": "/api/market/refresh-business-formation",
        "scheduler_job_id": "business_formation_fetch",
        "timezone": "Asia/Seoul",
        "market": "US",
        "default_schedule": {"enabled": True, "type": "daily", "time": "06:10"},
    },
    {
        "id": "labor_surveys_fetch",
        "label": "고용 조사 수집",
        "category": "market",
        "schedule_desc": "매일 06:20",
        "usage": ["Market Hub 고용 조사 격차"],
        "source": ["FRED"],
        "editable": True,
        "trigger_kinds": ["auto", "manual"],
        "manual_endpoint": "/api/market/refresh-labor-surveys",
        "scheduler_job_id": "labor_surveys_fetch",
        "timezone": "Asia/Seoul",
        "market": "US",
        "default_schedule": {"enabled": True, "type": "daily", "time": "06:20"},
    },
    {
        "id": "trimmed_inflation_fetch",
        "label": "절사평균 물가 수집",
        "category": "market",
        "schedule_desc": "매일 06:30",
        "usage": ["Market Hub 절사평균 물가"],
        "source": ["FRED"],
        "editable": True,
        "trigger_kinds": ["auto", "manual"],
        "manual_endpoint": "/api/market/refresh-trimmed-inflation",
        "scheduler_job_id": "trimmed_inflation_fetch",
        "timezone": "Asia/Seoul",
        "market": "US",
    ...
    },
    {
        ...
        "trigger_kinds": ["auto"],
        "manual_endpoint": None,
        "scheduler_job_id": "cowork_enrich_verify",
        "timezone": "Asia/Seoul",
        "market": "공통",
        "default_schedule": {"enabled": True, "type": "daily", "time": "08:00"},
    },
