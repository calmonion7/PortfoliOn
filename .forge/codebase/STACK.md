...
`api.js`를 우회해 `fetch`를 직접 쓰는 곳(`frontend/src/App.jsx:36,133`,
...
| 변수 | 읽는 위치 | 용도 |
|------|-----------|------|
| `VITE_API_BASE_URL` | `frontend/src/api.js:4`, `frontend/src/App.jsx:36,133`, `frontend/src/pages/LoginPage.jsx:8` | API 베이스. **미설정 시 빈 문자열 = 상대경로**(nginx 동일 오리진 서빙 전제) |
