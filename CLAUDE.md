...
- `backend/services/` — storage, market (yfinance+Naver API), charts, indicators, report_generator, scraper, consensus, consensus_pipeline, cache, guru_scraper, guru_stats, digest_service, leverage_service, analysis_service, auth_service, utils (NaN/Inf sanitize), db, errors, parallel, progress
