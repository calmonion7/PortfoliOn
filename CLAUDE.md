...
- `backend/data/calendar/` — 레거시 캘린더 파일 캐시 (YYYY-MM.json, gitignored) — **dead store**: 캘린더 라이브 캐시는 PostgreSQL `calendar_cache` 테이블 (task#166)
