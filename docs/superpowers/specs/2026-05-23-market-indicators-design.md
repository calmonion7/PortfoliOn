...
**S&P 나머지 바스켓 (10종):**  
BRK-B · JPM · V · WMT · UNH · JNJ · PG · XOM · MA · HD

**KOSPI Top2:** 005930 (삼성전자) · 000660 (SK하이닉스)

**KOSPI 나머지 바스켓 (10종):**  
005380 (현대차) · 373220 (LG에너지솔루션) · 207940 (삼성바이오로직스) · 005490 (포스코홀딩스) · 105560 (KB금융) · 068270 (셀트리온) · 055550 (신한지주) · 051910 (LG화학) · 000270 (기아) · 012330 (현대모비스)
...
- `get_m7_earnings()` → M7 7종 + 나머지 10종 분기별 Net Income 합산, 최근 8분기
- `get_kr_top2_earnings()` → 삼성+하이닉스 2종 + 나머지 10종 분기별 순이익, Naver API, 최근 8분기
...
**국채금리 섹션 상세:**
- 수치 카드 4개: 3M / 5Y / 10Y / 30Y — 현재값(%) + 전일대비(±bp)
- LineChart: 2Y와 10Y 1년 일별 히스토리, 스프레드(10Y-2Y) 보조선
...
- Naver API 종목 일부 실패: 실패 종목 제외하고 나머지로 합산 (부분 데이터 허용)
